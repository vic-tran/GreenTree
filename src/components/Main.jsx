      ...
      <div className="main">
        ...
        <div className="content">
          ...
          <section class="flex justify-center mt-5">
            <div class="bg-gray-600 py-3 w-6/12 md:w-4/12 rounded text-center border-b-4 border-white flex justify-center opacity-80 ...">
              <p class="font-sans text-xl w-11/12">
