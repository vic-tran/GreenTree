...
const Contact = () => {
  return (
    <div className="main">
      <Navbar />
      <div>
        <img className="relative" src={Greenbelt} alt="" />
      </div>
      <div className="content">
        <h1 className="mt-20">Contact Us</h1>
        <form
          className="opacity-90 h-max"
          action="https://getform.io/f/7f383f7b-4250-4a39-b280-728f486f7c7c"
          method="POST"
          enctype="multipart/form-data"
        >
          <input
            className="grid md:grid-cols-2 gap-4 w-full py-2 p-2 text-black mt-4"
            type="text"
            name="First Name"
          ...
          />
          <button
            className="w-full bg-transparent hover:bg-blue-400 font-bold p-4 text-white rounded-lg px-4 py-2"
            type="submit"
          >
            Submit
          </button>
